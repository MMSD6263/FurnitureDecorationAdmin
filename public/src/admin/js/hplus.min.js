...
layer.config({
    ...
    $("#side-menu .nav-item").metisMenu(), $(".right-sidebar-toggle").click(function () {
    ...
    }), $(".full-height-scroll").slimScroll({height: "100%"}), $("#side-menu .nav-item>li").click(function () {
        $("body").hasClass("mini-navbar") && NavToggle()
    }), $("#side-menu .nav-item>li li a").click(function () {
